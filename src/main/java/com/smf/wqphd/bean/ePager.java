...
public class ePager<T> {
    ...
    public ePager(Integer page, Integer size, T condition, String sort, String ord, Date fromDate, Date toDate) {
        this.page = page;
        this.size = size;
    ...
    public ePager(Integer page, Integer size, T condition) {
        super();
        this.page = page;
        this.size = size;
        this.condition = condition;
    ...
    public ePager(Integer page, Integer size) {
        super();
        setPage(page);
        setSize(size);
    }

    public ePager(T condition) {
        super();
        this.condition = condition;
    }

    public ePager(Integer total) {
        super();
        setTotal(total);
    }
